...
function blogita_scripts() {
	...
	wp_enqueue_style( 'blogita-master', get_template_directory_uri() . '/assets/css/master.css', array(), _S_VERSION );
	wp_enqueue_style( 'blogita-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'blogita-main', get_template_directory_uri() . '/assets/js/main.js', array(), _S_VERSION, true );
